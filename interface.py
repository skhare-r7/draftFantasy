...
class interface:
    def __init__(self,game):
        ...
        self.telegramIds['Ripu'] = 564076157
        ...
        self.telegramIds['Srikaran'] = 547170419
        self.telegramIds['Anoop'] = 506798991
        ...
        dispatcher.add_handler(CommandHandler('token',self.token))
    ...
    def canceltokens(self,bot,update):
        self.processCommand('canceltokens', update)
